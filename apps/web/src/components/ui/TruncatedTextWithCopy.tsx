...
export function TruncatedTextWithCopy({
  ...
  return (
    <div
      className={`inline-flex cursor-pointer items-center gap-1.5 transition-colors group select-none ${containerClassName}`}
      onClick={handleCopy}
    ...
    >
      <span
        className={`max-w-xs overflow-hidden text-ellipsis whitespace-nowrap group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors ${textClassName}`}
      >
        {truncatedText}
      </span>
